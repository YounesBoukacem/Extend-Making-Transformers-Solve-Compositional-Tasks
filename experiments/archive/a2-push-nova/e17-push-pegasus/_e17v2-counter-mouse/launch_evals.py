...
TESTS_ROOT_FOLDER = "/data/yb2618/DL_project_MVA/data/d12-vestroia-bench/"
DDIR = "/data/yb2618/DL_project_MVA/data/d8-push-vestroia/"
...
for deviceid, test_set in enumerate(test_sets):
	
	# Create the eval subfolder
	eval_name = test_set.replace(".txt", "")
	eval_folder = Path(f"./{eval_name}")
