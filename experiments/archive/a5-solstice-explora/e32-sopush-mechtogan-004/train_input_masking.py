...
# Set the device ids
deviceids = [0, 1, 2, 3] # Set the device ids to use for training
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../e31-sopush-mechtogan-003/checkpoints/checkpoint_2.00.pth", map_location=device))
