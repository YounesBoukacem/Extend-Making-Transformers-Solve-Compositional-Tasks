...
# Set the device ids
deviceids = [2, 3, 4, 5] # Set the device ids to use for training
...
# Create the model
model = GPT()
model.load_state_dict(torch.load("../archive/a2-push-nova/e18-push-ventus/checkpoints/best-model.pth", map_location=device))
