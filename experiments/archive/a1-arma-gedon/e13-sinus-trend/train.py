...
nb_lr_schedule_periods = 3
lr_schedule_period = math.ceil(max_iters / nb_lr_schedule_periods)
max_iters = lr_schedule_period * nb_lr_schedule_periods  # adjust max_iters to be multiple of lr_schedule_period
learning_rate = 1e-3 # Initial Learning rate value
decay_lr = True
warmup_iters = int(0.1 * lr_schedule_period)
lr_decay_iters = lr_schedule_period
assert lr_decay_iters <= lr_schedule_period
