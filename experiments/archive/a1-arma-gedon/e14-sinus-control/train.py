...
period_iters = max_iters // sum(lr_schedule_periods)
...
class Block(nn.Module):
	...
	def __init__(self, n_embd, n_head):
		...
		# self.ln1 = F.rms_norm(normalized_shape=n_embd, eps=1e-5)
		# self.ln2 = F.rms_norm(normalized_shape=n_embd, eps=1e-5)
