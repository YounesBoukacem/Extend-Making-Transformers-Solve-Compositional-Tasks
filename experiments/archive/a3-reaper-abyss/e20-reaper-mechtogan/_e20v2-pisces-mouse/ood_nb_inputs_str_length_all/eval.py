...
args.add_argument("--test_set_path", type=str, required=True)
args.add_argument("--ddir", type=str, required=True)
args.add_argument("--deviceid", type=int, required=True)
parser = args.parse_args()

#============================================
## Setting the path to the test data and the model
#============================================

DDIR  = parser.ddir # Data directory
test_set_path = parser.test_set_path # Path to the test set file
...
#============================================
## Defining some utility functions for logging and time conversion
#============================================
...
n_embd = 256	  # Embedding dimension for 120M
